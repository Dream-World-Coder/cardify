...
export default function CardGenerator() {
  ...
  const downloadCard = async (): Promise<void> => {
    ...
    canvas.width = cardSize * scale;
    canvas.height = cardSize * scale;
    ...
    else if (alignment === "end") ctx.textAlign = "right";
    ...
    const lines: string[] = [];
    const maxWidth = cardSize * 0.8;
    const padding = cardSize * 0.1;
    ...
    let startY: number;
    if (alignment === "center") startY = (cardSize - totalHeight) / 2;
    else if (alignment === "end") startY = cardSize - totalHeight - padding;
    else startY = padding;

    let xPos: number;
    if (alignment === "center") xPos = cardSize / 2;
    else if (alignment === "end") xPos = cardSize - padding;
    else xPos = padding;
